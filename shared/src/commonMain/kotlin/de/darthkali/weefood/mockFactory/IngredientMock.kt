...
object IngredientMock {
    ...
    val ingredientDomainList = listOf(
        ...
        Ingredient(name = "Zucker", image = "sugar-in-bowl.png", apiId = 19335, quantity = 8F, unit =  "Hase"),
        Ingredient(name = "Nudeln", image = "fusilli.jpg", apiId = 20420, quantity = 9F, unit =  "Hase"),
        Ingredient(name = "Reis", image = "uncooked-white-rice.png", apiId =20444 , quantity = 5F, unit =  "Hase"),
        Ingredient(name = "Milch", image = "milk.png", apiId = 1077, quantity = 5F, unit =  "Hase"),
        Ingredient(name = "Tee", image = "tea-bags.jpg", apiId = 14355, quantity = 5F, unit =  "Hase"),
        Ingredient(name = "Kaffee", image = "brewed-coffee.jpg", apiId = 14209, quantity = 5F, unit =  "Hase"),
